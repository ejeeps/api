...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $licenseType = !empty($_POST['license_type']) ? $_POST['license_type'] : null;
        ...
        try {
            ...
            if (isset($_POST['dashboard_view']) || isset($_GET['dashboard_view'])) {
                header("Location: ../../view/driver/settings.php?page=settings&success=1");
            } else {
                header("Location: ../../view/driver/settings.php?success=1");
            }
            exit();
        ...
        if (isset($_POST['dashboard_view']) || isset($_GET['dashboard_view'])) {
            ...
            header("Location: ../../view/driver/settings.php?error=" . $errorMessage);
        }
        exit();
    }
} else {
    ...
    if (isset($_GET['dashboard_view'])) {
        ...
        header("Location: ../../view/driver/settings.php");
    }
    exit();
}
